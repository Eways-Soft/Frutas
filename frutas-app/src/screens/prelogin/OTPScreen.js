        ...
        setisLoading(true)         
          ...
          fetch(`${BASE_URL}api/otp_verify`, {
            ...
            if (result.CODE === 200) {
              ...
              var utoken = await AsyncStorage.getItem('test_userToken');
              var udata = await AsyncStorage.getItem('test_USER_DATA')
              
              await AsyncStorage.setItem('userToken', utoken);
              await AsyncStorage.setItem('USER_DATA', udata)

              await AsyncStorage.removeItem('test_userToken');
              await AsyncStorage.removeItem('test_USER_DATA');
