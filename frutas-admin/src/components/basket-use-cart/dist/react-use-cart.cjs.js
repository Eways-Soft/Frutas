...
var generateCartState = function (state, items) {
    ...
    return __assign(__assign(__assign({}, initialState), state), { items: calculateItemTotals(items), totalItems: calculateTotalItems(items), totalUniqueItems: totalUniqueItems, cartTotal: calculateCartTotal(items), cartWeight: calculateCartWeight(items), cartWeightgm: calculateCartWeightgm(items), isEmpty: isEmpty });
};
...
var CartProvider = function (_a) {
    ...
    var updateItemQuantity = function (id, quantity, weight_in_kg, weight_in_gm) {
        ...
        console.log('weight_in_kg :',weight_in_kg)
        console.log('weight_in_gm :',weight_in_gm)
        if (quantity <= 0) {
