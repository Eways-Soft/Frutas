...
const List = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${config.baseUrl}/admin/app/helthslider/getallhelthslider`, {
      method: "GET",
      headers: {
    ...
    return (
      <>
        ...
        <span className="blank_space d-flex align-items-center">
          <h2></h2>
          {AddSetting &&
            <Link to="/apphelthslideradd" className="nav-link btn btn-primary ml-auto theme_button top_fixed_buton" >Add New</Link>
          }
        </span>
                        ...
                        <AgGridColumn headerName="Edit" field="city_id" sortable={false} editable={false}
                          ...
                          cellRendererFramework={(data) => {
                            return (
                              <>
                                {EditSetting &&
                                  <Link to={'/apphelthslideredit/'+ data.data.id } ><i class="icon-pencil"></i></Link>
                                }
                              </>
                            )
                          }}
