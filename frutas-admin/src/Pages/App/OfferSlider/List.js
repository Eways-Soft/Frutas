...
const List = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${config.baseUrl}/admin/app/offerslider/getallofferslider`, {
      method: "GET",
      headers: {
    ...
    return (
      <>
        ...
        <span className="blank_space d-flex align-items-center">
          <h2></h2>
          {AddSetting &&
            <Link to="/appofferslideradd" className="nav-link btn btn-primary ml-auto theme_button top_fixed_buton" >Add New</Link>
          }
        </span>
                    ...
                    <div className="card">                   
                      ...
                      <AgGridReact
                        ...
                        <AgGridColumn headerName="Edit" field="city_id" sortable={false} editable={false}
                          ...
                          cellRendererFramework={(data) => {
                            return (
                              <>
                                {EditSetting && 
                                  <Link to={'/appofferslideredit/'+ data.data.id } ><i class="icon-pencil"></i></Link>
                                }
                              </>
                            )
                          }}
                        ...
                        />
                          ...
                          <AgGridColumn width="200px"  headerName="Basket Category" field="basket_category_name" />
                          <AgGridColumn headerName="Status" field="get_status" sortable={true}
                            cellRendererFramework={(data) => {
